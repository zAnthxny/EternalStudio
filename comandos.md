...
InvRollback centraliza casi toda su operacion en el comando base `invrollback`, con alias `invrestore`.
...
- Los archivos se guardan en `plugins/InvRollback/exports/`.
